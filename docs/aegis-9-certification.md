...
AEGIS-9 Falcon tier requires a live failover demonstration during the assessment, not just documentation. Our most recent demonstration achieved full regional failover in **10 minutes**, well under the Falcon threshold of 30 minutes.
